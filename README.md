# Module: MMMgHoroscope
The `MMMgHoroscope ` module is one modules for [MagicMirror²](https://github.com/MichMich/MagicMirror) project.
This module displays horoscope headlines based on an RSS feed.
